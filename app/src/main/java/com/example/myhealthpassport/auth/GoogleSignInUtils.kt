    ...
    companion object {
        ...
        suspend fun signIn(context: Context): Result<Unit> {
            ...
            return try {
                ...
                Log.w(TAG, "No saved account, trying account picker")
                tryWithAccountPicker(context)
        ...
        private suspend fun tryWithAccountPicker(context: Context): Result<Unit> {
            return try {
                val credentialManager = CredentialManager.create(context)
                ...
                Log.e(TAG, "Account picker also failed: ${e.message}")
                Result.failure(e)
            }
        }

        private suspend fun handleCredential(credential: androidx.credentials.Credential): Result<Unit> {
